...
GRAY = "#5D6872"
LIGHT = "#F4F6F7"
matplotlib.rcParams["svg.hashsalt"] = "failure-atomic-tool-admission-v0.2.2"
    ...
    for suffix in ("png", "svg", "pdf"):
        if suffix == "svg":
            ...
            metadata = {
                ...
                "Creator": "failure-atomic-tool-admission v0.2.2",
                "CreationDate": fixed,
                "ModDate": fixed,
            }
        else:
            metadata = {"Software": "failure-atomic-tool-admission v0.2.2"}
